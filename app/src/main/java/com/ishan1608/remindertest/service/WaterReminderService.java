...
public class WaterReminderService extends IntentService {
    ...
    public static final String WATER_REMINDER_TASK_REPEATED_CANCEL = "com.ishan1608.remindertest.service.action.WATER_REMINDER_TASK_REPEATED_CANCEL";
    ...
    public static class AlarmReceiver extends BroadcastReceiver {
        ...
        private void sendNotification(Context context, String title, String msg) {
            Log.d(TAG, "sendNotification called with msg " + msg);
            waterReminderNotificationManager = (NotificationManager) context
                    .getSystemService(Context.NOTIFICATION_SERVICE);
